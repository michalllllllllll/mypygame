...
panel = 150
coins = 0
player1 = Player(0,0) #we need to pass img in the Player() constructor
...
for r in range(grid_r):
    for c in range(grid_c):
        if grid[r][c] == 0:
            obstacleList.append(Obstacle(c*cell_size, r*cell_size))
...
while run:
    ...
    # screen.fill("#ffffff")
    screen.fill((255, 255, 255))#adds background image to the screen
